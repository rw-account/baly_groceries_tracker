...
If you distribute a modified version of this application, including through public app stores or APK repositories, you must:

* Use a different application name.
* Use a different package name (Application ID / Bundle ID).
...
For permission to use the project's branding or for trademark-related questions, please contact the project maintainer through GitHub.
